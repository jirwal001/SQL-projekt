...
-----------------------------------------------------------------------------
----- I přes poklesy mezd v některých rocích u některých odvětví je ve všech odvětvích trend rostoucí 
...
----- Nejvíce poklesu zaznamenaly odvětví B(Těžba a dobývání) 4x, O(Veřejná správa a obrana; povinné sociální zabezpečení), R(Kulturní, zábavní a rekreační činnosti), I(Ubytování, stravování a pohostinství) 3x
